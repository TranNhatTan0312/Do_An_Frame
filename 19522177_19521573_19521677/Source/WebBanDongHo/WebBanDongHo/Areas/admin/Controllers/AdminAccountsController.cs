...
namespace WebBanDongHo.Areas.admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(bandonghoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var bandonghoContext = _context.Accounts.Include(a => a.Role);
            return View(await bandonghoContext.ToListAsync());
        }
